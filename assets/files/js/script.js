...
var config = {
	apiKey: "AIzaSyBBnJsnvWXLobq7Pa7qvnn_3Ayq72r4ksQ",
	authDomain: "aiuto-team.firebaseapp.com",
	databaseURL: "https://aiuto-team.firebaseio.com",
	projectId: "aiuto-team",
	storageBucket: "aiuto-team.appspot.com",
	messagingSenderId: "11104861335"
};
...
function submitForm(e){
  ...
  var email = document.getElementById("emailiduser").value;
  var phone = document.getElementById("tel").value;
	var school = document.getElementById("schooluser").value;
	var grade = document.getElementById("gradeuser").value;
  saveMessage(name,email,phone, school, grade);
  window.location.href="personalisedngos2.html"

}


function saveMessage(name,email,phone, school, grade){
